...
@app.on_message(filters.command("pdfwatermark"), group=10)
...
@app.on_message(filters.document, group=10)
...
@app.on_message(filters.command("pdfask"), group=10)
...
@app.on_message(filters.text & ~filters.command(["pdfwatermark", "pdfask"]), group=10)
